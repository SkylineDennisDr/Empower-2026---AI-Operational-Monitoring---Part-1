...
Open the `Empower 2026 - AI Operational Monitoring - Part 1.cs` file to write custom installation code. Common actions include creating elements, services, or views.
